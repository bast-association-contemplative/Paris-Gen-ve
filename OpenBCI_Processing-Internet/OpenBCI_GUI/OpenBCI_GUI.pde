...
void draw() {
  ...
  //nchan > nombre de channel 8 ou 16
  //println(synthesizeData(nchan, openBCI.get_fs_Hz(), openBCI.get_scale_fac_uVolts_per_count(0), dataPacketBuff[lastReadDataPacketInd]));

  //println(randomGaussian()*sqrt(openBCI.get_fs_Hz()/2.0f));
